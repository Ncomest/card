...
import type { ICard, ICardsTotal } from "@/entities/card";
import { fetchApi } from "@/shared/api";
import { Button } from "@/shared/ui/button";
import { StyledButton } from "@/shared/lib/styles";
import { OptionsList } from "./OptionsList";
import { CardInCreateDeck } from "./CardInCreateDeck";
import { CardListInCreateDeck } from "./CardListInCreateDeck";
...
export const CreateDeckPage = () => {
  ...
  const handleDropdownFilter = (name: string, value: string) => {
    setPage(1);
    setDropdownFilter((prev) => ({ ...prev, [name]: value }));
  };
