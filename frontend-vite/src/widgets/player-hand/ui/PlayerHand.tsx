...
import { SelectDeck } from "@/features/select-deck";
...
export const PlayerHand: React.FC<TPlayerHandProps> = ({
  hand,
  setHand,
  handleDragStart,
  handleDragOver,
  ...
  return (
    <ComponentStyle>
      <NewDeckContainerStyle>
        <NavStyled>
          <Button type="game" size="l" onClick={handleRandomDeck}>
            Случайно
          </Button>
        ...
        <SelectDeck onClick={handleSelectCurrentDeck} />
      </NewDeckContainerStyle>
